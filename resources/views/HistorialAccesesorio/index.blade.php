...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#accesesoriosHistorial').DataTable({
                processing: true,
                serverSide: true,
                order: [
                    [0, 'desc']
                ...
                searching: false,
                ajax: {
                    url: "{{ route('accesesorioshistorial.lista') }}",
                    data: function(d) {
                        d.empleado = $('#filtro_empleado').val(); // 👉 ENVIAR FILTRO AL SERVIDOR
                    }
                },
                lengthChange: true,
                lengthMenu: [
                ...
                columns: [{
                    ...
                    {
                        data: 'accesesorio.categoria.nombre',
                        name: 'accesesorio.categoria.nombre',
                        defaultContent: ''
                    },
                    {
                        data: 'accesesorio.n_serial',
                        name: 'accesesorio.n_serial',
                        defaultContent: ''
                    },
                    {
