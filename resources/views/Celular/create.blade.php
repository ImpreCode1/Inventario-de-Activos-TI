        ...
        <div class="card-body">
            <form action="/celulares" method="POST">
                ...
                <div>
                    ...
                    <input type="text" name="modelo" id="modelo" class="form-control" placeholder="Modelo del celular"
                        tabindex="3">
                </div>
                <div>
                    <label for="" class="form-label">Numero de de telefono</label>
                    <input type="text" name="n_telefono" id="n_telefono" class="form-control" placeholder="Numero de telefono"
                        tabindex="4">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="serial_sim" id="serial_sim" class="form-control" placeholder="Serial SIM"
                        tabindex="7">
                </div>
                <div>
                    <label for="" class="form-label">Memoria RAM</label>
                    <input type="text" name="ram" id="ram" class="form-control" placeholder="Memoria RAM"
                        tabindex="8">
                </div>
                <div>
                    <label for="" class="form-label">Almacenamiento</label>
                    <input type="text" name="rom" id="rom" class="form-control" placeholder="Almacenamiento"
                        tabindex="9">
                </div>
                <div>
