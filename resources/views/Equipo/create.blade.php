        ...
        <div class="card-body">
            <form action="/equipos" method="POST">
                ...
                <div>
                    ...
                    <input type="text" name="memoria_ram" id="memoria_ram" class="form-control" placeholder="Memoria Ram"
                        tabindex="7">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="discoduro" id="discoduro" class="form-control" placeholder="Discoduro"
                        tabindex="9">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="nom_equipo" id="nom_equipo" class="form-control" placeholder="Nombre del equipo"
                        tabindex="12">
                </div>
                <br>
